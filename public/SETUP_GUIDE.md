...
### ধাপ ৪: Supabase Database Webhooks (৩টা)

Supabase Dashboard → **Database → Webhooks** → **Create a new hook** — এই ৩টা টেবিলের
জন্য আলাদা আলাদা করে বানান (প্রতিটার সেটিংস একই রকম, শুধু Table আলাদা):

| Table | Events | Method | URL | Header |
|---|---|---|---|---|
| `comments` | Insert | POST | `https://yourdomain.vercel.app/api/send-push` | `x-webhook-secret: <NOTIFY_WEBHOOK_SECRET এর মান>` |
